<?php /* Smarty version 2.6.31, created on 2019-05-10 18:22:57
         compiled from index.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'cat', 'index.tpl', 13, false),array('modifier', 'number_format', 'index.tpl', 19, false),array('modifier', 'date_format', 'index.tpl', 32, false),)), $this); ?>
<div class="index">
    <h2>通販サイトからのお知らせ</h2>
...
">
 ...
 value="商品詳細ページ">
    ...
    <h2>新商品</h2>
    <div class="new-items">
        <?php $_from = $this->_tpl_vars['form']['recently_added_items']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['item']):
?>
            <div class="new-item">
                <h3><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['created_at'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%m月%d日") : smarty_modifier_date_format($_tmp, "%m月%d日")); ?>
 追加</h3>
                <?php if ($this->_tpl_vars['item']['image'] != NULL): ?>
                    <img src="<?php echo ((is_array($_tmp="./images/")) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['item']['image']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['item']['image'])); ?>
">
